              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between py-3 border-b">
                  ...
                  <span className={`px-3 py-1 rounded-full text-sm ${
                    ...
                    {user.status === 'open' ? t('register.statusOpen') : t('register.statusClosed')}
                  </span>
                </div>

                {user.telegram && (
                  <div className="flex items-center justify-between py-3 border-b">
                    <span className="font-medium">{t('dashboard.telegram')}</span>
                    <button
                ...
                <div className="flex gap-4 pt-4">
                  <button onClick={handleCall} className="btn btn-primary flex items-center gap-2 flex-1">
